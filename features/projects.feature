...
#       And I should see "5000000"
  ...
  Scenario: Edit project without permission
    Given there is a user with the email "vumanhcuong01@gmail.com" and the id "2" and the password "12345678" and the password confirmation "12345678"
      And I am a new, authenticated user
      And there is a project with the title "Push The World" and the user id "333" and the description "test slug" and the start date "2013-09-11" and the end date "2013-09-12" and the funding goal "234234" and the location "HCM" 
    When I go to the editing project page of "Push The World"
