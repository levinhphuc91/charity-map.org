...
Before '@api-call' do
  ...
  FakeWeb.register_uri(:get, "https://staging-charitio.herokuapp.com/v1/users/update",
    ...
    :content_type => 'application/json',
    :status => "200")
  FakeWeb.register_uri(:post, 'https://' + ENV['CAMPAIGN_MONITOR_API_KEY'] + ':x@api.createsend.com/api/v3/subscribers/2b0bc2d32f4bab37be1dcdf67fed88e6.json',
    :body => File.new("#{Rails.root}/features/support/json/campaign_monitor_new_subscriber.json"),
    :content_type => 'application/json',
    :status => "200")
  FakeWeb.register_uri(:get, 'http://www.google-analytics.com/collect?v=1&tid=UA-32552864-2&cid=555&t=event&ec=SignUp&ea=Successful&ev=1',
    :status => "200")
end
